...
class mcauth(commands.Cog):
    ...
    @cog_ext.cog_slash(name="token", description="Megmutatja a regisztrált tokent", options=None, guild_ids=[737284142462402560])
    ...
    @cog_ext.cog_slash(name="mcauth", description="Nem eredetis játékosok ezzel tudnak karaktert regisztrálni", options=auth_options, guild_ids=[737284142462402560])
